<?php
    ...
    if ($pi_calculator->getErrorMsg() != '') {
        ...
        if ($pi_calculator->getPostParameter('calcValue') != '' && $pi_calculator->getPostParameter('calcMethod') != '') {
            ...
            <div
                id="piRpNotfication"><?php echo $pi_lang_information . ":<br/>" . $pi_lang_info[$pi_calculator->getCode()]; ?></div>
        <?php } ?>
        <div id="piRpResult">
            ...
            <table id="piInstallmentTerms" cellspacing="0">
                <tr>
                    <td id="piInstallmentFirstTd">
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoPaymentPrice')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoPaymentPrice')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        <div class="piRpFloatLeft"><?php echo $pi_lang_cash_payment_price; ?>:</div>
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoPaymentPrice"><?php echo $pi_lang_mouseover_cash_payment_price; ?></div>
                        </div>
                    </td>
                    <td></td>
                ...
                <tr class="piTableHr">
                    <td>
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoServiceCharge')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoServiceCharge')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoServiceCharge"><?php echo $pi_lang_mouseover_service_charge; ?></div>
                        </div>
                    </td>
                    <td></td>
                ...
                <tr class="piPriceSectionHead">
                    <td class="piRpPercentWidth">
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoEffectiveRate')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoEffectiveRate')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoEffectiveRate"><?php echo $pi_lang_mouseover_effective_rate; ?></div>
                        </div>
                    </td>
                ...
                <tr class="piTableHr">
                    <td>
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoDebitRate')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoDebitRate')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoDebitRate"><?php echo $pi_lang_mouseover_debit_rate; ?></div>
                        </div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoInterestAmount')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoInterestAmount')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoInterestAmount"><?php echo $pi_lang_mouseover_interest_amount; ?></div>
                        </div>
                    </td>
                    <td></td>
                ...
                <tr>
                    <td>
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoTotalAmount')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoTotalAmount')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoTotalAmount"><?php echo $pi_lang_mouseover_total_amount; ?></div>
                        </div>
                    </td>
                    <td></td>
                ...
                <tr>
                    <td colspan="4">
                        <div class="piRpFloatLeft">&nbsp;
                            <div>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <div class="piRpFloatLeft piRpMarginBottom"><?php echo $pi_lang_calulation_result_text ?>
                            <div>
                    </td>
                </tr>
                ...
                <tr class="piRpyellow piPriceSectionHead">
                    <td class="piRpPaddingTop">
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoDurationTime')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoDurationTime')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoDurationTime"><?php echo $pi_lang_mouseover_duration_time; ?></div>
                        </div>
                    </td>
                    <td colspan="3" class="piRpPaddingRight piRpPaddingTop">
                        <b><?php echo $pi_resultArray['numberOfRatesFull']; ?><?php if (!$pi_lang_months) echo '&nbsp;';
                                echo $pi_lang_months; ?></b></td>
                </tr>
                <tr class="piRpyellow">
                    <td>
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoDurationMonth')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoDurationMonth')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        <div class="piRpFloatLeft piRpPaddingLeft">
                            <b><?php echo $pi_resultArray['numberOfRates']; ?><?php echo $pi_lang_duration_month; ?>
                                :</b></div>
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoDurationMonth"><?php echo $pi_lang_mouseover_duration_month; ?></div>
                        </div>
                    </td>
                ...
                <tr class="piRpyellow piRpPaddingBottom">
                    <td class="piRpPaddingBottom">
                        <div class="piRpInfoImgDiv"><img onMouseOver="piMouseOver('piRpMouseoverInfoLastRate')"
                                                         onMouseOut="piMouseOut('piRpMouseoverInfoLastRate')"
                                                         class="piRpInfoImg"
                                                         src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png"/>
                        </div>
                        ...
                        <div class="piRpRelativePosition">
                            <div class="piRpMouseoverInfo"
                                 id="piRpMouseoverInfoLastRate"><?php echo $pi_lang_mouseover_last_rate; ?></div>
                        </div>
                    </td>
                    <td colspan="2" class="piRpPaddingBottom"><b>&nbsp;<?php echo $pi_resultArray['lastRate']; ?>
                            &nbsp;</b></td>
                    <td class="piRpPaddingRight piRpPaddingBottom"><b>&euro;</b></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <div class="piRpCalculationText "><?php echo $pi_lang_calulation_example; ?></div>
                    </td>
                </tr>
            </table>
        </div>
