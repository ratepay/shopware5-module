<?php
    ...
    class Shopware_Plugins_Frontend_RpayRatePay_Bootstrap extends Shopware_Components_Plugin_Bootstrap
    {
        ...
        public function onPostDispatch(Enlight_Event_EventArgs $args)
        {
            ...
            //$klarnaSavedRegister = $session->get('klarnaSavedRegister');
            //$klarnaOrder = $session['KlarnaOrder'];
            ...
            /*if (($user = $view->sUserData) !== null
                ...
                && (
                    ...
                    || $session['sPaymentID'] == $config->get('paymentDefault')
                )
            ) {
                ...
                $session['KlarnaOrder'] = $klarnaOrder;
                $session['klarnaSavedRegister'] = $klarnaSavedRegister;
