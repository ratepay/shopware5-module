...
{block name="ratepay_payment_method__ic_plan"}
    <table class="table table-striped">
        <tr>
            <td class="text-center text-uppercase headline" colspan="2">{$ratepay.translations.rp_personal_calculation}</td>
        </tr>

        <tr>
            <td class="warning small text-center" colspan="2">{$ratepay.plan.responseText}<br/>{$ratepay.translations.rp_calulation_example}</td>
        </tr>
        ...
        <tr class="rp-installment-plan-details">
            ...
            <td class="text-right">{$ratepay.plan.amount} &euro;</td>
        </tr>
        ...
        <tr class="rp-installment-plan-details">
            ...
            <td class="text-right">{$ratepay.plan.serviceCharge} &euro;</td>
        </tr>
        ...
        <tr class="rp-installment-plan-details">
            ...
            <td class="text-right">{$ratepay.plan.annualPercentageRate} %</td>
        </tr>
        ...
        <tr class="rp-installment-plan-details">
            ...
            <td class="text-right">{$ratepay.plan.interestAmount} &euro;</td>
        </tr>
        ...
        <tr class="rp-installment-plan-no-details">
            ...
            <td class="text-right">{$ratepay.plan.rate} &euro;</td>
        </tr>
        ...
        <tr class="rp-installment-plan-details">
            ...
            <td class="text-right">{$ratepay.plan.lastRate} &euro;</td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-right">{$ratepay.plan.totalAmount} &euro;</td>
        </tr>
